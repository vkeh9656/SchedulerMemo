...
// SchedulerMemoDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "SchedulerMemo.h"
#include "SchedulerMemoDlg.h"
...
CSchedulerMemoDlg::CSchedulerMemoDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SCHEDULERMEMO_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CSchedulerMemoDlg::DoDataExchange(CDataExchange* pDX)
{
...
// CSchedulerMemoDlg 메시지 처리기

BOOL CSchedulerMemoDlg::OnInitDialog()
{
...
void CSchedulerMemoDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CSchedulerMemoDlg::OnQueryDragIcon()
{
